...
(function ($) {
    ...
    $.fn.lightGallery = function (options) {
        ...
        var setUp = {
            ...
            structure: function () {
                $('body').append('<div id="lg-outer" class="' + settings.addClass + '"><div id="lg-gallery"><div id="lg-slider"></div><a id="lg-close" class="close-button"></a></div></div>').addClass('light-gallery');
            ...
            buildThumbnail: function () {
                if (settings.thumbnail === true && $children.length > 1) {
                    ...
                    if (!settings.showThumbByDefault) {
                        $close = '<span class="close-button ib"><i class="bUi-iCn-rMv-16" aria-hidden="true"></i></span>';
                    }
                    ...
                    $gallery.find('.thumb-cont .close-button').bind('click touchend', function () {
