...
<!-- box-5 -->
            <section id="box-5-w" data-speed="-3" data-type="background" class="box-5-1">
                <div id="box-5" class="ani-2">
                    ...
                    <p><a href="/">Главная</a> > Продукция</p>
                    <div class="clear"></div>
                </div>
            </section>
        <!-- box-6 -->
            <div id="box-6-w">
                <div id="box-6">
                    <!-- -->
                    <a href="<?php the_field('rubrika_1_ssylka'); ?>" class="box-6 box-6-left ani-3">
                        <img src="<?php the_field('rubriki1'); ?>" alt="">
                        <div class="clear"></div>
                    </a>
                    <!-- -->
                    <a href="<?php the_field('rubrika_2_ssylka'); ?>" class="box-6 box-6-right ani-3">
